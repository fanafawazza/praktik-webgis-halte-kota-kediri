...
map.getView().fit([12463699.796435, -876472.673259, 12484254.397421, -866500.608999], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Halte Kota Kediri</h2>';
        return titleElement;
    })(),
